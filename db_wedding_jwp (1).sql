...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jul 2024 pada 21.06
...
(5, '2024EuropeBerlin28_1328471224.png', 'Paket Hemat 3', '<p>Paket Pernikahan Sederhana dirancang untuk pasangan yang menginginkan perayaan intim dengan keluarga dan teman terdekat. Dengan paket ini, kami menyediakan semua kebutuhan dasar pernikahan Anda tanpa mengorbankan kualitas dan keindahan acara.</p><p><span style=\"font-weight: bolder;\">Termasuk:</span></p><ul><li>Dekorasi standar untuk gedung atau rumah</li><li>1000 undangan</li><li>2 set busana pengantin (akad dan resepsi)</li><li>Tata rias dan rambut untuk pengantin wanita</li></ul>', 120000000, 'Y', 1, '2024-07-28 19:55:18', '2024-07-28 19:55:52');
